            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex items-center ml-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-2" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1404px, 61px, 0px);" data-popper-placement="bottom">
                    ...
                    <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        <ul class="pb-2 space-y-2">
                            ...
                            @foreach($menu as $menuSection)
                                <li>
                                    <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-{{ $menuSection['id'] }}" data-collapse-toggle="dropdown-{{ $menuSection['id'] }}">
                                        ...
                                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">{{ $menuSection['title'] }}</span>
                                        <svg sidebar-toggle-item="dropdown-{{ $menuSection['id'] }}" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                    </button>
                                    @isset ($menuSection['items'])
                                        <ul id="dropdown-{{ $menuSection['id'] }}" class="space-y-2 py-2 {{ $menuSection['active'] ? '' : ' hidden' }}">
                                            @foreach($menuSection['items'] as $childItem)
                                                <li>
                                                    @if (false && $childItem['active'])
                                                        <a href="{{ $childItem['url'] }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700  bg-gray-100 dark:bg-gray-700 ">{{ $childItem['title'] }}</a>
                                                    @else
                                                        <a href="{{ $childItem['url'] }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">{{ $childItem['title'] }}</a>
                                                    @endif
                                                </li>
                                            @endforeach
                                        </ul>
            ...
            <main>
                <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
                    <div class="w-full mb-1">
                        <div class="mb-4">
                            {{ Breadcrumbs::render('admin.catalog.products.create') }}
                ...
                @if(session()->has('success'))
                    <div class="flex mt-4 p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
