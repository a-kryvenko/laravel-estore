<x-app-layout>
    <section class="py-10 bg-gray-100">
        <div class="mx-auto grid max-w-6xl grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            @for ($i = 0; $i < 6; $i ++)
                <article class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5 hover:shadow-xl duration-500">
                    <a href="/">
                        <img class="rounded-t-lg" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="">
                    </a>
                    <div class="p-5">
                        <a href="/">
                            <h2 class="text-gray-900 font-bold text-2xl tracking-tight mb-2">Noteworthy technology acquisitions 2021</h2>
                        </a>
                        ...
                        <a class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center" target="_blank">
                            Read more
                        </a>
                    </div>
                </article>
    ...
    <section class="py-10 bg-gray-100">
        <div class="mx-auto grid max-w-6xl grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            @for ($i = 0; $i < 24; $i ++)
                <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl duration-500">
                    <a href="/">
