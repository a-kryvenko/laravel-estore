...
<div class="bg-white p7 rounded w-9/12 mx-auto" data-entity="drag-n-drop-container">
...
<script>
    ...
    function dataFileDnD() {
        return {
            ...
            fileDragging: null,
            fileDropping: null,
            form: document.querySelector('[data-entity="drag-n-drop-container"]').closest('form'),
            humanFileSize(size) {
            ...
            remove(index) {
                ...
                if (files[index].id) {
                    this.removedFiles.push(files[index].id);
                }
